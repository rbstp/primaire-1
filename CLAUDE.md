...
- **Consignes courtes.** On dit la chose deux fois, sans consigne autour: une consigne parlée revient dix fois par séance. Une lettre se nomme « la lettre a », en une seule phrase, parce qu'un nom d'une syllabe passe trop vite et qu'une pause entre « la lettre » et « a » colle le « a » à la phrase suivante. Un chiffre se dit par son mot, deux fois.
